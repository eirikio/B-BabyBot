...
def login():
    ...
    print("-----------------------")
    baby_name = driver.find_element(
        By.XPATH, '/html/body/div[6]/div/div/div[2]/section/div[4]/div/form/input')
    name = baby_name.get_attribute("value")
    print("Hi " + name)
    print("-----------------------")
    print("Your current skills are: ")

    dex = driver.find_element(
        By.XPATH, '/html/body/div[2]/div/div/div[1]/div[2]/ul/li[1]/h3').text
    app = driver.find_element(
        By.XPATH, '/html/body/div[2]/div/div/div[1]/div[2]/ul/li[2]/h3').text
    play = driver.find_element(
        By.XPATH, '/html/body/div[2]/div/div/div[1]/div[2]/ul/li[3]/h3').text
    kind = driver.find_element(
        By.XPATH, '/html/body/div[2]/div/div/div[1]/div[2]/ul/li[4]/h3').text
    pat = driver.find_element(
        By.XPATH, '/html/body/div[2]/div/div/div[1]/div[2]/ul/li[5]/h3').text
    pers = driver.find_element(
        By.XPATH, '/html/body/div[2]/div/div/div[1]/div[3]/ul/li[1]/h3').text
    intell = driver.find_element(
        By.XPATH, '/html/body/div[2]/div/div/div[1]/div[2]/ul/li[2]/h3').text
    obed = driver.find_element(
        By.XPATH, '/html/body/div[2]/div/div/div[1]/div[2]/ul/li[3]/h3').text
    sleep_skills = driver.find_element(
        By.XPATH, '/html/body/div[2]/div/div/div[1]/div[2]/ul/li[4]/h3').text
    ador = driver.find_element(
        By.XPATH, '/html/body/div[2]/div/div/div[1]/div[2]/ul/li[5]/h3').text
    print('Dexterity: ' + dex)
    print('Appetite: ' + app)
...
def babyScript():
    while running:
        ...
        driver.find_element(
            By.XPATH, '/html/body/div[2]/div/div/div[3]/div[2]/div[3]/button').click()
        sleep(3)
        # WebDriverWait(driver, 20).until(EC.element_to_be_clickable(By.XPATH, '/html/body/div[12]/div/button[1]')).click()
        driver.find_element(
            By.XPATH, '/html/body/div[12]/div/button[1]').click()
        sleep(2)
        driver.find_element(
            By.XPATH, '/html/body/div[12]/div/button[1]').click()
        sleep(2)
        skill_gain = driver.find_element(
            By.XPATH, '/html/body/div[12]/div/div[6]/div/div/h2').text
        skill_tree = driver.find_element(
            By.XPATH, '/html/body/div[12]/div/div[6]/div/div/img').get_attribute('src')
